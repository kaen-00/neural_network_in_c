...
void print_NN(NNET *nn) {
    for(int i=0;i<nn->layers;i++) {
        ...
        printf("Layer size: %d\n", nn->layer_size[i]);
        printf("Activation_v\n");
        mat_print(nn->activations_v[i]);
        printf("====================\n");
        printf("Weights_m\n");
        mat_print(nn->weights_m[i]);
        printf("====================\n");
        printf("bias_v\n");
        mat_print(nn->bias_v[i]);
        printf("====================\n");
        printf("error_v\n");
        mat_print(nn->error_v[i]);
        printf("====================\n");
        printf("del_weights_m\n");
        mat_print(nn->del_weights_m[i]);
        printf("====================\n");
        printf("del_bias_v\n");
        mat_print(nn->del_bias_v[i]);
        printf("====================\n");
    }
}
